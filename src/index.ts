...
//initialize
    ...
    const updatePages = async (user) => {
        ...
        const channels:any[] = pageResult.items
                    ...
                    if (!request.ok) {
                        ...
                        const observedItems:Element[] = returnDomList(sitecontent,singlePage.observeName,singlePage.contains)
                            ...
                            if (singlePage.updates != observedItems.length || lastPost.textContent != singlePage.laspost) {
                                ...
                                const postid = uniqid().substring(0,15)
    ...
    app.get('/rss/:user',async (req, res) => {
        ...
        const rssfeed = new RSS({
            ...
            feed_url: `http://localhost:${PORT}/rss/${req.params.user}`,
           ...
           const pageResult = await client.records.getList('feeditem', 1, 50, {
            ...
            rssfeed.item({
                ...
                <br/>
                <br/>
                <p><a href="${`http://localhost:${PORT}/#/new?id=${item["@expand"]?.channel?.id}`}"> <img style="width:62px" src="data:image/png;base64,"/>ibhub</a></p>
                `,
                guid:item.postid,
